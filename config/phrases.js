...
module.exports = {
  ...
  // Enterprise Admin UI
  'Search for enterprise accounts': 'Search for enterprise accounts',
  'No enterprise accounts exist for that search.': 'No enterprise accounts exist for that search.',
  ...
  'Select a specific workflow action to execute for this enterprise account.': 'Select a specific workflow action to execute for this enterprise account.',
  'Action': 'Action',
  'Select action...': 'Select action...',
  'Send Proposal': 'Send Proposal',
  'Generate Contract Document': 'Generate Contract Document',
  'Approve Contract for Signature': 'Approve Contract for Signature',
  'Send Contract for Signature': 'Send Contract for Signature',
  'Initiate Contract': 'Initiate Contract',
  'Setup Account': 'Setup Account',
  'Complete Onboarding': 'Complete Onboarding',
  'Contract Documents': 'Contract Documents',
  'Version: %s': 'Version: %s',
  'Created: %s': 'Created: %s',
  'Approved by %s on %s': 'Approved by %s on %s',
  'Pending admin review and approval': 'Pending admin review and approval',
  'View Document': 'View Document',
  'Use \'Approve Contract for Signature\' action to approve this document for sending to the customer.': 'Use \'Approve Contract for Signature\' action to approve this document for sending to the customer.',
  'No contract documents generated yet': 'No contract documents generated yet',
  'Notes (Optional)': 'Notes (Optional)',
  'Add any notes about this workflow action...': 'Add any notes about this workflow action...',
  ...
  'Recent Enterprise Payments': 'Recent Enterprise Payments',
  'Customer': 'Customer',
  'Plan': 'Plan',
  'Unknown User': 'Unknown User',
  'No recent enterprise payments found.': 'No recent enterprise payments found.',
  'Dashboard': 'Dashboard',
  ...
  'Issue': 'Issue',
  'Contract renewal needed': 'Contract renewal needed',
  ...
  'Bulk actions for this stage': 'Bulk actions for this stage',
  'Recent Activity': 'Recent Activity',
  'No recent activity': 'No recent activity',
  'Bulk Status Update': 'Bulk Status Update',
  'Select Accounts': 'Select Accounts',
  'Select accounts to update from the pipeline above': 'Select accounts to update from the pipeline above',
  ...
  'Create New Enterprise Account': 'Create New Enterprise Account',
  'Create a new enterprise account from initial inquiry information.': 'Create a new enterprise account from initial inquiry information.',
  'Company Name': 'Company Name',
  'Primary Contact Name': 'Primary Contact Name',
  'Primary Contact Email': 'Primary Contact Email',
  'Initial Notes': 'Initial Notes',
  'Add any notes from the initial inquiry...': 'Add any notes from the initial inquiry...',
  'Create Account': 'Create Account',

  ENTERPRISE_PLAN_REQUIRED:
    'Please <a class="font-weight-bold" href="%s">upgrade to the Enterprise Plan</a> to access this feature.',
  ENTERPRISE_ACCOUNT_DOES_NOT_EXIST: 'Enterprise account does not exist.',
  ENTERPRISE_ACCOUNT_CREATED:
    'Enterprise account has been created successfully.',
  ENTERPRISE_ACCOUNT_UPDATED:
    'Enterprise account has been updated successfully.',
  NOTE_CONTENT_REQUIRED: 'Note content is required.',
  NOTE_ADDED: 'Note has been added successfully.',
  DOCUMENT_UPLOADED: 'Document has been uploaded successfully.',
  SIGNATURE_DETAILS_REQUIRED:
    'Document ID, signer email, and signer name are required.',
  DOCUMENT_NOT_FOUND: 'Document not found.',
  INVALID_SIGNATURE_PROVIDER: 'Invalid signature provider selected.',
  SIGNATURE_REQUEST_SENT: 'Document has been sent for signature successfully.',
  SIGNATURE_REQUEST_FAILED: 'Failed to send document for signature.',
  INVALID_WEBHOOK_PROVIDER: 'Invalid webhook provider.',
  NO_SIGNATURE_REQUEST_FOUND: 'No signature request found for this document.',
  CANNOT_ADVANCE_STAGE: 'Cannot advance to next stage.',
  ACCOUNT_ADVANCED_TO_NEXT_STAGE:
    'Account has been advanced to the next stage.',
  WORKFLOW_ACTION_COMPLETED: 'Workflow action completed successfully.',
  ACTION_REQUIRED: 'Action is required.',
  INVALID_ACTION: 'Invalid workflow action selected.',
  BULK_STATUS_UPDATE_SUCCESS: 'Successfully updated %d accounts.',
  BULK_UPDATE_PARTIAL_ERRORS: '%d accounts had errors during update.',
  ONBOARDING_STATUS_UPDATED: 'Onboarding status has been updated.',
  ACCOUNT_IDS_REQUIRED: 'Account IDs are required for bulk update.',
